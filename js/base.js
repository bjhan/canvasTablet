...
//    } else
    ...
    function adpAllStyle(styleStr, id, callback, adp, bool) {
        ...
        isNaN(adp - 0) && (bool ? adp = 1280 : adp = 720);
    ...
    /*========== Private API ==========*/
    function getMatchNumber(str_source, str_tomatch){
        var num = 1;
        for(var i = 0; i<str_tomatch.length; i++){
            if(str_source.indexOf(str_tomatch.charAt(i)) > 0){
                num++;
            }
        }
        return num;
